...
def Breed2(p1,p2,num,gsc='gc1',ps1='p1',ps2='p2'):
	for j in range(num):		
		c1 = DoSeqGeneration(p1,p2,num,gsc+str(j))
...
############################################
def SplitPresets():
	data = OpenFile('../MophoKey_programs_1.1.syx')		
	for i in range(0,3):
...
os.chdir('.\gen1')
GenSplice('..\Patches\data_b0p18.syx')
